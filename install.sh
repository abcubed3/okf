...
case "${OS}" in
  darwin)  OS="darwin" ;;
  linux)   OS="linux" ;;
  *)       echo "Unsupported OS: ${OS}. Only macOS and Linux are supported by this script."; exit 1 ;;
esac
...
echo "Successfully installed ${BINARY} to ${TARGET_DIR}/${BINARY}"
